...
# 🚀 Executive Summary {background-color="#1a1a2e"}

::: {.columns}
::: {.column width="60%"}
**The Challenge:**
Aircraft engines are expensive. Replacing them too early wastes money; replacing them too late risks catastrophic failure.

**The Goal:**
Predict the **Remaining Useful Life (RUL)** of turbofan engines using high-frequency sensor data.

**The Dataset:**
NASA C-MAPSS — 4 subsets with increasing complexity.
:::
...
## 🚀 The Solution: AeroGuard {auto-animate=true}

**AeroGuard** — a hierarchical AI pipeline integrating:

::: {.incremental}
1.  **Statistical Survival Analysis** (Cox Proportional Hazards)
2.  **Unsupervised Forensics** (K-Means & Hierarchical Clustering)
...
We systematically conquered each NASA C-MAPSS dataset with increasing complexity.

| Dataset | Complexity | Key Challenge | Method | AeroGuard RMSE |
|:---|:---|:---|:---|:---:|
| **FD001** | Baseline | Single Regime, Single Fault | Survival + Random Forest | **17.53** |
| **FD002** | Multi-Regime | 6 Operating Conditions | Regime Clustering + Hybrid Ensemble | **26.54** |
| **FD003** | Multi-Fault | 2 Failure Mechanisms | Fault Classifier + XGBoost | **20.05** |
| **FD004** | **Ultimate** | Regimes + Faults Combined | **Grand Unified Pipeline** | **32.97** |

::: {.fragment .fade-up}
**Result:** State-of-the-art performance across all operational scenarios. RMSE < 20 is excellent; < 35 for FD004 is competitive.
:::

---

## 📂 Project Resources & Live Demo {auto-animate=true}
...
|:---:|:---|:---|
| 1 | `Engine_Predictive_Maintenance.ipynb` | Cox PH + Random Forest |
| 2 | `AeroGuard_FD002_MultiRegime.ipynb` | K-Means + Hybrid Ensemble |
| 3 | `AeroGuard_FD003_Diagnostics.ipynb` | Hierarchical + Fault-Aware XGB |
| 4 | `AeroGuard_FD004_Ultimate.ipynb` | Grand Unified Pipeline |
:::
...
- **Live Presentation:** [aymenmb.github.io/AeroGuard](https://aymenmb.github.io/AeroGuard)
- **NASA Dataset:** [C-MAPSS Data](https://data.nasa.gov/dataset/C-MAPSS-Aircraft-Engine-Simulator-Data/x339-9te4)
